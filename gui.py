...
search_param_file_label = tk.Label(root, text="Search param in every found entity:")
search_param_file_entry = tk.Entry(root, textvariable=search_param_file, width=80)
...
def save():
    ...
    save_data_from_last_run(api_url_str, cookie_str, entity_search_param_str, search_param_file_str)
...
def proces_request_fetch_click():
    ...
    entity_search_param_str = entity_search_param.get()
    search_param_file_str = search_param_file.get()
    get_data(api_url_str, cookie_str, entity_search_param_str, search_param_file_str)
...
fetch_button = tk.Button(root, text="Fetch", command=proces_request_fetch_click)
fetch_button.grid(row=0, column=2, padx=(0, 50))

refill_blacklist_button = tk.Button(root, text="Refill Blacklist", command=process_request_blacklist_click)
